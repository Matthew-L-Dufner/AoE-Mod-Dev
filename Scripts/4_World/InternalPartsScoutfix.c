class InternalPartsScoutfix extends RecipeBase
{
	override void Init()
	{
		m_Name = "Convert to Internal Parts (fixed).";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"InternalPartsScoutfuq");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("InternalPartsScoutfix");//add results here
