class CM_Conversion_Guide extends RecipeBase
{
	override void Init()
	{
		m_Name = "Learn about Creedmoor Rounds";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Book_TheAOEAshFall");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"AmmoBox_65CM");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CM_Conversion_Guide");//add results here
