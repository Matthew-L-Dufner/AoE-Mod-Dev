class ViperCamoPaintcan extends RecipeBase
{
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Ratnik_ZOD");//you can insert multiple ingredients this way
		...
		AddResult("ViperCamoPaintcan");//single result
