class M110Externals extends RecipeBase
{
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"MassM110");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("M110Externals");//add results here
