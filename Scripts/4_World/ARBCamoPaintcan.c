class ARBCamoPaintcan extends RecipeBase
{
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Ratnik_RP");//you can insert multiple ingredients this way
		...
		AddResult("ARBCamoPaintcan");//single result
