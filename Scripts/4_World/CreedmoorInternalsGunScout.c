class CreedmoorInternalsGunScout extends RecipeBase
{
	override void Init()
	{
		m_Name = "Convert to Creedmoor Internals for the Scout Rifle.";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SA65CM_RED_Scout");//you can insert multiple ingredients this way
		InsertIngredient(0,"SA65CM_GRN_Scout");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CreedmoorInternalsScout");//add results here
