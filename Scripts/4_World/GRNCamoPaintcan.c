class GRNCamoPaintcan extends RecipeBase
{
	override void Init()
	{
		m_Name = "Extract Camo Colors.";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SpecOpsHeavyPlateCarrier");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"colorextractor");//you can insert multiple ingredients this way
		...
		AddResult("GRNCamoPaintcan");//single result
