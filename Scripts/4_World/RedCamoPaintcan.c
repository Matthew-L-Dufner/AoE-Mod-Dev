class ExtractRedCamo extends RecipeBase
{
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"ZODHeavyPlateCarrier");//you can insert multiple ingredients this way
		...
		AddResult("RedCamoPaintcan");//single result
