class ZOD716G2Externals extends RecipeBase
{
	override void Init()
	{
		m_Name = "Convert to Colored Parts";
		m_IsInstaRecipe = 0;//should this recipe be performed instantly without animation
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"M110Externals");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"ViperCamoPaintcan");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("ZOD716G2Externals");//add results here

		m_ResultSetFullQuantity[0] = 0;//true = set full quantity, false = do nothing
