class SS716G2ZOD extends RecipeBase
{
	override void Init()
	{
		m_Name = "Assemble the 716G2 ZOD Variant";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"ZOD716G2Externals");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"CreedmoorInternals417");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SS716G2ZOD");//add results here
