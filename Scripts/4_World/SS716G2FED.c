class SS716G2FED extends RecipeBase
{
	override void Init()
	{
		m_Name = "Assemble the 716G2 FED Variant";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"FED716G2Externals");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SS716G2FED");//add results here
