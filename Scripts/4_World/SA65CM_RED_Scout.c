class SA65CM_RED_Scout extends RecipeBase
{
	override void Init()
	{
		m_Name = "Assemble the 6.5 Creedmoor Red Camo Scout Rifle.";
		...
		//ingredient 2
		InsertIngredient(1,"RedCamoExternals");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SA65CM_RED_Scout");//add results here
