class FED716G2Externals extends RecipeBase
{
	override void Init()
	{
		m_Name = "Convert to External Parts";
		...
		//ingredient 2
		InsertIngredient(1,"ARBCamoPaintcan");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("FED716G2Externals");//add results here
