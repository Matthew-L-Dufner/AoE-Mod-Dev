class InternalPartsScoutfuq extends RecipeBase
{
	override void Init()
	{
		m_Name = "Convert to Internal Parts (FUCKED)";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"MassScout556");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"M67Grenade");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("InternalPartsScoutfuq");//add results here
