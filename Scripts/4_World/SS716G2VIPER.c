class SS716G2VIPER extends RecipeBase
{
	override void Init()
	{
		m_Name = "Convert to FULL-AUTO!";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SS716G2ZOD");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"FiringSelector");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SS716G2VIPER");//add results here
