class CreedmoorInternals417 extends RecipeBase
{
	override void Init()
	{
		m_Name = "Convert from Creedmoor Internals (weak)";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"CreedmoorInternals417weak");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"FiringMechanism");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CreedmoorInternals417");//add results here
