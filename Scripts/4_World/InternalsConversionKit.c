class InternalsConversionKit extends RecipeBase
{
	override void Init()
	{
		m_Name = "Create the Conversion Kit.";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"CM_Conversion_Guide");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("InternalsConversionKit");//add results here
