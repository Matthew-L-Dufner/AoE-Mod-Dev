class CreedmoorInternals417weak extends RecipeBase
{
	override void Init()
	{
		m_Name = "Convert from Scout Creedmoor internals.";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"CreedmoorInternalsScout");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"InternalsConversionKit");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CreedmoorInternals417weak");//add results here
