class RedCamoExternals extends RecipeBase
{
	override void Init()
	{
		m_Name = "Create Red Camo External Parts.";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"ScoutExternals");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"RedCamoPaintcan");//you can insert multiple ingredients this way
		...
		AddResult("RedCamoExternals");//single result
