class SA65CM_GRN_Scout extends RecipeBase
{
	override void Init()
	{
		m_Name = "Assemble the 6.5 Creedmoor Green Camo Scout Rifle.";
		...
		//ingredient 2
		InsertIngredient(1,"GreenCamoExternals");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SA65CM_GRN_Scout");//add results here
