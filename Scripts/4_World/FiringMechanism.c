class FiringMechanism extends RecipeBase
{
	override void Init()
	{
		m_Name = "Borrowing a strong Firing Mechanism";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Massm300");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("FiringMechanism");//add results here
